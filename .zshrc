...
export mENV="/run/media/marvel/data/Coding/Malcolm-next/malcolm/bin/activate"
export mRUN="/run/media/marvel/data/Coding/Malcolm-next/src/bot.py"
export mCONF="/run/media/marvel/data/Coding/Malcolm-next/config.ini"
